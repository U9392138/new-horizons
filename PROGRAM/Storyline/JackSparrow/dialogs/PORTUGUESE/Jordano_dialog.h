...
"Sim?",
"...",
"Você trouxe novidades do Garanhão? Ele disse que enviaria seus homens. Todos nós estávamos esperando.",
"Sim, ele me enviou. Mas não anuncie para toda a cidade!",
"Desculpe senhor. Vou manter isso baixo. Mas onde está o seu medalhão? Disseram-me para perguntar sobre o seu medalhão.",
...
"Não. O garanhão não nos contou.",
"Isso é inteligente. É melhor assim. 'Sussurros sujos estão por aí', como dizem. E onde está o próprio garanhão? Não podemos partir sem ele.",
...
"Sim senhor. Terei todos nós prontos para partir quando você voltar.",
"Bom rapaz. Com certeza mencionarei seu bom trabalho ao Garanhão.",
};
